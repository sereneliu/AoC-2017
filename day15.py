...
def gen_A(starting_value_a):
    return (starting_value_a * 16807) % 2147483647

def gen_A_criteria(a):
    a = gen_A(a)
    while a % 4 != 0:
        a = gen_A(a)
    return a

def gen_B(starting_value_b):
    return (starting_value_b * 48271) % 2147483647

def gen_B_criteria(b):
    b = gen_B(b)
    while b % 8 != 0:
        b = gen_B(b)
    return b
